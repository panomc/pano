...
enum class ErrorCode {
    ...
    POST_CATEGORY_UPDATE_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_50,
    POST_CATEGORY_UPDATE_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_51,

    POST_CATEGORY_DELETE_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_52,
    POST_CATEGORY_DELETE_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_53,

    POST_NOT_FOUND,

    EDIT_POST_PAGE_INIT_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_54,
    EDIT_POST_PAGE_INIT_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_55,

    DELETE_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_56,
    DELETE_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_57,

    PUBLISH_ONLY_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_58,
    PUBLISH_ONLY_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_59,
    PUBLISH_ONLY_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_60,

    MOVE_TRASH_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_61,
    MOVE_TRASH_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_62,

    MOVE_DRAFT_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_63,
    MOVE_DRAFT_POST_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_64,
