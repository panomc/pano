...
@Suppress("ClassName")
@Migration
class DatabaseMigration_32_33(databaseManager: DatabaseManager) : DatabaseMigration(databaseManager) {
    ...
    private fun createNotificationTable(): suspend (sqlConnection: SqlConnection) -> Unit =
