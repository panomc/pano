    ...
    private fun getCountOfCategories(
        ...
        databaseManager.getSQLConnection(connection).query(query) { queryResult ->
            if (queryResult.succeeded())
                ...
                databaseManager.closeConnection(connection) {
                    resultHandler.invoke(Error(ErrorCode.POST_CATEGORY_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_43))
                }
        }
    }
    ...
    private fun getCategories(
        ...
        databaseManager.getSQLConnection(connection).query(query) { queryResult ->
            if (queryResult.succeeded()) {
                ...
                databaseManager.closeConnection(connection) {
                    resultHandler.invoke(Error(ErrorCode.POST_CATEGORY_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_42))
                }
        }
    }
}