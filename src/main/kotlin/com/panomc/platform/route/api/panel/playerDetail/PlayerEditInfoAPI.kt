...
class PlayerEditInfoAPI : PanelApi() {
    ...
    private fun isExistsByIDHandler(
        ...
        if (exists == null) {
            databaseManager.closeConnection(sqlConnection) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_209))
            }
    ...
    private fun getByIDHandler(
        ...
        if (user == null) {
            databaseManager.closeConnection(sqlConnection) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_210))
            }
    ...
    private fun isExistsByUsernameHandler(
        ...
        if (exists == null) {
            databaseManager.closeConnection(sqlConnection) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_211))
            }
    ...
    private fun isEmailExistsHandler(
        ...
        if (isEmailExists == null) {
            databaseManager.closeConnection(sqlConnection) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_212))
            }
    ...
    private fun setUsernameByIDHandler(
        ...
        if (result == null) {
            databaseManager.closeConnection(sqlConnection) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_213))
            }
    ...
    private fun setEmailByIDHandler(
        ...
        if (result == null) {
            databaseManager.closeConnection(sqlConnection) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_214))
            }
    ...
    private fun setPasswordByIDHandler(
        ...
        databaseManager.closeConnection(sqlConnection) {
            if (result == null) {
                handler.invoke(Error(ErrorCode.UNKNOWN_ERROR_215))
