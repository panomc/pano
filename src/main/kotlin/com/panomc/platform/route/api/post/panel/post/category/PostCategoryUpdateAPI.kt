        ...
        databaseManager.getSQLConnection(connection)
            .queryWithParams(query, JsonArray().add(url).add(id)) { queryResult ->
                if (queryResult.succeeded())
                    ...
                    databaseManager.closeConnection(connection) {
                        resultHandler.invoke(Error(ErrorCode.POST_CATEGORY_UPDATE_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_51))
                    }
            }
    }
    ...
    private fun updateCategoryToDB(
        ...
        databaseManager.getSQLConnection(connection).updateWithParams(
            ...
            if (queryResult.succeeded())
                ...
                databaseManager.closeConnection(connection) {
                    resultHandler.invoke(Error(ErrorCode.POST_CATEGORY_UPDATE_API_SORRY_AN_ERROR_OCCURRED_ERROR_CODE_50))
                }
        }
    }
